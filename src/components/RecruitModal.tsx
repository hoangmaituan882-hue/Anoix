        ...
        <div className="p-6 sm:p-8 border-b border-white/10 flex items-center justify-between bg-[#151515]">
          <div>
            <span className="text-xs font-black text-[#e0fe3d] uppercase tracking-widest">
              JOIN THE TRIGGER CREATIVE TEAM
            </span>
        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-8 text-sm sm:text-base leading-relaxed">
          ...
          <div>
            <h4 className="text-sm font-black text-white uppercase tracking-wider mb-4 flex items-center gap-2">
              ...
              <span>RECRUITMENT POSITIONS (募集職種)</span>
            </h4>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/5 p-5 rounded-2xl border border-white/10">
                <h5 className="font-black text-lg text-white mb-2">1. アニメーター (作画・原画・動画)</h5>
              ...
              <div className="bg-white/5 p-5 rounded-2xl border border-white/10">
                <h5 className="font-black text-lg text-white mb-2">2. 制作進行 (Production Coordinator)</h5>
                <p className="text-xs sm:text-sm text-white/70 mb-3">
              ...
              <div className="bg-white/5 p-5 rounded-2xl border border-white/10">
                <h5 className="font-black text-lg text-white mb-2">3. 3DCG / 撮影スタッフ</h5>
                <p className="text-xs sm:text-sm text-white/70 mb-3">
              ...
              <div className="bg-white/5 p-5 rounded-2xl border border-white/10">
                <h5 className="font-black text-lg text-white mb-2">4. 美術・背景スタッフ</h5>
                <p className="text-xs sm:text-sm text-white/70 mb-3">
          ...
          <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
            ...
            <div className="flex items-center gap-2 text-xs font-bold text-white/60">
              ...
              <span>宛先：recruit@st-trigger.co.jp</span>
            </div>
          </div>
        </div>
      </div>
